        ...
        <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
            ...
            <div className="mt-12 flex flex-col items-center">
              <div className="w-full flex-1 mt-8">
                ...
                <div className="mx-auto max-w-xs">
                  ...
                  />
                  <input
                    className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5 !text-black focus:text-black"
                    type="password"
                    placeholder="Password"
                  />
                  <button className="mt-5 tracking-wide font-semibold bg-amber-400 text-white-500 w-full py-4 rounded-lg hover:bg-amber-300 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                    <svg
          ...
          <div className="flex-1 bg-amber-100 text-center hidden lg:flex">
            <div
              ...
              style={{
                backgroundImage:
                  'url("https://images.pexels.com/photos/4551127/pexels-photo-4551127.jpeg")',
              }}
            ></div>
          </div>
        </div>
